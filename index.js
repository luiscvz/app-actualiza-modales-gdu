...
var startPage = 51;
var endPage = 53; //tope maximo en 41 si son 1000 x pagina
var stepPage = 2;
var maxPage = 204;
         ...
         request(options, function (error, response) {
            ...
            if (index == (dataSkus.length - 1)) {
               ...
               if (endPage < (maxPage - stepPage)) {
                  ...
                  setTimeout(function () {
                     resolve();
                     console.log('Arranca nuevo lote en pagina ' + startPage + ' hasta ' + endPage);
                     iniciaProceso();
                     terminaPromesa();
                  }, 1000);
               }
